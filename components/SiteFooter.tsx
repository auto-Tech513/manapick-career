...
export function SiteFooter() {
  return <footer className="site-footer"><div className="footer-inner">
    ...
    <nav aria-label="フッターナビゲーション">
      <div><strong>仕事を知る</strong><Link href="/all/">556職業名録</Link><Link href="/ranking/">人気アクセス</Link><Link href="/guide/">ガイド</Link><Link href="/news/">キャリアニュース</Link><Link href="/skills/">スキル</Link><Link href="/shop/">career manapi商店</Link></div>
