...
- [x] 運用記録と生成物除外を整えたPull Request [#4](https://github.com/auto-Tech513/manapick-career/pull/4)をマージし、merge commit `5b9f5358e61db4f2cdbcb1908aba6ec508fd7871` を本番deployment `f498f00b` として公開する（2026-07-20）
- [x] 最終照合記録をPull Request [#5](https://github.com/auto-Tech513/manapick-career/pull/5)でマージし、merge commit `bb14f777c7621346425fca0c2eaa5708657224b8` を本番deployment `884b701e` として公開する（2026-07-20。以後の最新値はGitHub・Cloudflareの履歴を正本にする）
