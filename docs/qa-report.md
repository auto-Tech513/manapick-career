...
現リリースはGitHub Pull Request [#3](https://github.com/auto-Tech513/manapick-career/pull/3)で `main` へマージし、merge commit `78f36cdb11bc5268e9b2f26e85eef29a9abdb346` をCloudflare Pagesの本番deployment `29eaf1a9` として公開した。Cloudflare管理画面のProduction source、公開URL、公開HTMLを2026-07-20に照合した。
