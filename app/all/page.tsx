...
export const metadata: Metadata = { title: "job tag出典の556職業名録・確認済み職業解説", description: "job tag解説系データから職業名・別名・分類を検索し、公式job tagまたは人が出典・学び・AI・資格を確認した独自解説へ進める職業名録です。", alternates: { canonical: "/all/" } };
