  ...
  return <><JsonLd data={graph}/><div className="page-shell occupation-detail-page">
    ...
    <div className="occupation-detail-layout">
      ...
      <aside className="occupation-detail-side">
        ...
        <div className="occupation-next-actions"><strong>次の入口</strong><a href="https://manapick.app/?utm_source=career&utm_medium=referral&utm_campaign=occupation_detail" target="_blank" rel="noopener noreferrer"><GraduationCap aria-hidden="true" /><span>動画で学ぶ<small>manapick</small></span><ArrowUpRight aria-hidden="true" /></a><a href={aiSearch} target="_blank" rel="noopener noreferrer"><Bot aria-hidden="true" /><span>仕事に使うAI<small>manapick AIで検索</small></span><ArrowUpRight aria-hidden="true" /></a><a href="https://license.manapick.app/search/?utm_source=career&utm_medium=referral&utm_campaign=occupation_detail" target="_blank" rel="noopener noreferrer"><LibraryBig aria-hidden="true" /><span>資格要件を確認<small>manapick license</small></span><ArrowUpRight aria-hidden="true" /></a><Link href="/shop/"><BriefcaseBusiness aria-hidden="true" /><span>学習・仕事の道具<small>career manapi商店</small></span><ArrowRight aria-hidden="true" /></Link></div>
